...
/**
 * To avoid unnecessary communication overhead and keep the communication
 * between the StreamJit nodes optimal, don't implement unnecessary functions
 * here. Instead implement enum_dispatcher to dispatch the enum. Just for the
 * testing purpose I implemented toString().
 * 
