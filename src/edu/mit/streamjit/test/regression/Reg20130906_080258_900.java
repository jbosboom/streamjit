...
/**
 * @since 9/6/2013 8:02PM EDT
 */
@ServiceProvider(Benchmark.class)
public class Reg20130906_080258_900 implements Benchmark {
	@Override
	@SuppressWarnings({"unchecked", "rawtypes"})
	public OneToOneElement<Object, Object> instantiate() {
		return (OneToOneElement)new edu.mit.streamjit.impl.common.TestFilters.PeekingAdder(10);
	}
	@Override
	...
	public static void main(String[] args) {
		Benchmarker.runBenchmark(new Reg20130906_080258_900(), new edu.mit.streamjit.impl.compiler.CompilerStreamCompiler()).get(0).print(System.out);
	}
}
