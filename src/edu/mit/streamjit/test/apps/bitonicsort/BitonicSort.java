...
public class BitonicSort {
	...
	/**
	 * The driver class FIXME: Original is "void->void pipeline BitonicSort2".
	 * As StreamJit currently doesn't support FileReader<?>, FileWriter<?> and
	 * void input to the source worker, implementation is bit changed here. But
	 * anyway these need to be fixed soon. Correct class definition should be
	 * "private static class BitonicSort2 extends Pipeline<Void, Void>"
	 */
